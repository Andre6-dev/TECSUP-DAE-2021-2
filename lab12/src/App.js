...
class App extends Component {
  ...
  componentDidMount() {
    axios.get('https://localhost:8000/prestamos/')
      .then(res => {
  ...
  mostrar(cod, index) {
    axios.get('https://localhost:8000/prestamos/' + cod)
      .then(res => {
        this.setState({
          pos: index,
          titulo: 'Editar',
  ...
  guardar(e) {
    ...
    if (cod > 0) {
      ...
      axios.put('https://localhost:8000/prestamos/' + cod, datos)
        .then(res => {
      ...
      //nuevo registro
      axios.post('https://localhost:8000/prestamos/', datos)
        .then(res => {
  ...
  eliminar(cod) {
    ...
    if (rpta) {
      axios.delete('https://localhost:8000/prestamos/' + cod)
        .then(res => {
